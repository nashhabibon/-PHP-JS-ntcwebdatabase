						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="javascript:history.go(-1)">List</a></li>
									<li class="breadcrumb-item active" aria-current="page">Add Permits</li>
								</ol>
							</nav>
						</div>
...
<?php
 				...
 				include("../../config/connection.php");
  				$sql = "SELECT MAX(fileNo) as no FROM tblmobile_permit";
					...
					<div class="page-header">
						<div class="row">
							...
							<div class="col-md-6 col-sm-12 text-right">
								<label>File No : <?php echo $id?></label>
							</div>
						</div>
					</div>
									...
									<div class="row">
										...
										<div class="col-md-6 col-sm-12 text-right" style="margin-bottom: 10px;">
													<div class="form-group">
														...
														<input type="button" class="btn-link " value="Submit" id="btn-addMobile" style="color: #555; text-decoration: none; outline: 0!important;    background-color: transparent; border: 1px solid transparent;"></i> |
														 <i class="fa fa-floppy-o" aria-hidden="true">
												...
												<div class="col-md-12 col-sm-12" >
													<div class="form-group">
														<label >Business Name</label>
			    											<input type="text" class="form-control" id="BName" name="BName" aria-describedby="emailHelp" placeholder="Enter Business Name" required>
												...
												<div class="col-md-12 col-sm-12">
														<div class="form-group">
															<label >Business Address</label>
				    											<input type="text" class="form-control" id="BAddress" name="BAddress" placeholder="Enter Business Address" required>
				    											<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>
													</div>
													<div class="col-md-6 col-sm-12">
														<div class="form-group">
															<label >Business No (SEC/DTI)</label>
				    											<input type="text" class="form-control" id="BNo" name="BNo" placeholder="Enter Business No (SEC/DTI)" required>
				    											<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>	
													</div>
													...
													<div class="col-md-12 col-sm-12">
														...
														<div class="form-group">
															<label>Technician</label>
				    											<input type="text" class="form-control" id="tech" name="tech" placeholder="Enter Technician">
				    											<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>
													</div>	
												...
												<div class="input-group">
													...
													<div class="col-md-8 col-sm-12" >
														<div class="form-group">
															<label>Permit No</label>
				    											<input type="text" class="form-control" id="PermitNo" name="PermitNo" placeholder="Permit No" required>
							    								<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>
													</div>
													...
													<div class="col-md-6 col-sm-12">
														<div class="form-group">
															<label >Date Issued</label>
				    											<input type="date" class="form-control" id="dateIssued" name="dateIssued" placeholder="Enter Business Address" required>
				    											<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>
													</div>
													<div class="col-md-6 col-sm-12">
														<div class="form-group">
															<label >Date Expiry</label>
				    											<input type="date" class="form-control" id="dateExpiry" name="dateExpiry"  required >
				    											<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>
													</div>
													<div class="col-md-6 col-sm-12" >
														<div class="form-group">
																...
																<option value="LEGAL CHECKING">LEGAL CHECKING</option>
													...
													<div class="col-md-4 col-sm-12">
														<div class="form-group">
															<label >Official Reciept No.</label>
				    											<input type="number" class="form-control" id="OrNo" name="OrNo" placeholder="Enter Reciept No" required>
				    											<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>
													</div>
