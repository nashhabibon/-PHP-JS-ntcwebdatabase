					...
					<div class="page-header">
						<div class="row">
							...
							<?php
					 				...
					 				include("../../config/connection.php");
					  				$sql = "SELECT tblrlmpoperatorinfo.IDno, tblrlmpoperatorinfo.RlmpNo, tblrlmplicenseinfo.IDno, tblrlmplicenseinfo.OrNo FROM tblrlmplicenseinfo INNER JOIN tblrlmpoperatorinfo ON tblrlmplicenseinfo.IDno = tblrlmpoperatorinfo.IDno WHERE tblrlmplicenseinfo.tblID = (SELECT MAX(tblID) FROM tblrlmplicenseinfo WHERE Remarks = 'NEW')";

					                $sqlmax  = mysqli_query($conn, $sql);
					                $rowmax = mysqli_fetch_array($sqlmax);
					             	$rlmpNo = $rowmax['RlmpNo'];	
					             	$yr = date("y");

					             	if (empty($rlmpNo))
									   {
									  
									     $num = "RLMP-KK-" . "10000-" . $yr;
									   }
									   else
									   {
									     $a = str_replace("RLMP-KK", "", $rlmpNo);
									     $b = str_replace($yr, "", $a);
									     $c = str_replace("-", "", $b);
									     $d = $c + 1;
									...
									<div class="row">
										...
										<div class="col-md-6 col-sm-12 text-right" style="margin-bottom: 10px;">
													<div class="form-group">
														...
														<input type="button" class="btn-link " value="Submit" id="btn-addrlmp" style="color: #555; text-decoration: none; outline: 0!important;    background-color: transparent; border: 1px solid transparent;"></i>
														 <i class="fa fa-floppy-o" aria-hidden="true">
												...
												<div class="col-md-12 col-sm-12" >
													<div class="form-group">
														<label>Fullname (Firstname / Middle Initial / Lastname)</label>
			    											<input type="text" class="form-control" id="Fullname" aria-describedby="FullnameHelp" placeholder="Enter Fullname" name="Fullname" required>
													...
													<div class="col-md-4 col-sm-12" >
														<div class="form-group">
																<label>Province</label>
																 <select id="province" name="province" class="selectpicker form-control form-control-lg" data-style="btn-outline-secondary btn-lg" title="Not Chosen" > 
																 	    <?php
																     include("../../config/connection.php");
														...
														<div class="form-group">
																<label>City</label>
																<select class="form-control form-control-lg" data-style="btn-outline-secondary btn-lg" title="Not Chosen" name="City" autocomplete="off" id="City" required>
													...
													<div class="col-md-4 col-sm-12" >
														<div class="form-group">
																<label>Brgy.</label>
																<select class="form-control form-control-lg" data-style="btn-outline-secondary btn-lg" title="Not Chosen" name="Brgy" autocomplete="off" id="Brgy" required>
													...
													<div class="col-md-12 col-sm-12" >
														...
														<label>Prk/St./Village</label>
			    											<input type="text" class="form-control" id="Prk" aria-describedby="FullnameHelp" placeholder="Purok/St/Village" name="Prk">
						    								<div class="valid-feedback">Valid.</div>
						   									<div class="invalid-feedback">Please fill out this field.</div>
													</div>
													</div>
													...
													<div class="col-md-8 col-sm-12" >
														<div class="form-group">
															<label >Place of Seminar</label>
				    											<input type="text" class="form-control" id="Seminar" aria-describedby="EmployerAddressHelp" placeholder="Enter Place of Seminar" name="Seminar" required>
				    											<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>
													</div>
										...
										<div class="col-sm-12 col-md-6">
												<div class="input-group">
													...
													<div class="col-md-7 col-sm-12" >
														<div class="form-group">
															<label >Rlmp No.</label>
				    											<input type="text" class="form-control" id="rlmpNo" aria-describedby="RlmpnoHelp" placeholder="Enter RLMP No." name="rlmpNo" value=<?php echo $num ?> required>
				    											<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>
													</div>
													<div class="col-md-2 col-sm-12" >
														<div class="form-group">
															<label >No Of Year</label>
				    											<select class="selectpicker form-control form-control-lg" data-style="btn-outline-secondary btn-lg" title="Year" name="Year" autocomplete="off" id="Year" required>
													...
													<div class="col-md-12 col-sm-12" >
														<div class="form-group">
															<label >Employer</label>
				    											<input type="text" class="form-control" id="Employer" aria-describedby="EmployerHelp" placeholder="Enter Employer" name="Employer" required>
				    											<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>
													</div>
													<div class="col-md-12 col-sm-12" >
														<div class="form-group">
															<label >Employer Address</label>
				    											<input type="text" class="form-control" id="EmployerAddress" aria-describedby="EmployerAddressHelp" placeholder="Enter Employer" name="EmployerAddress" required>
				    											<div class="valid-feedback">Valid.</div>
							   									<div class="invalid-feedback">Please fill out this field.</div>
														</div>
													</div>
