	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="">
				...
				<h4 style="color: #160909;font-size: 20px;padding: 15px"> Encoder</h4>
			</a>
					...
					<li class="dropdown">
						...
						<ul class="submenu ">
							...
							<li >
								...
								<li class="active">
								<a href="javascript:;" class="dropdown-toggle " style="background-color: rgba(0,0,0,.4);">MOBILE PHONE</a>
				                    <ul class="submenu">
				                        <li><a href="mobile-permits.php" >MPRR</a></li>
				                        <li><a href="mpd-permits.php" style="background-color: rgba(0,0,0,.4);">MPD</a></li>
				                        <li><a href="mpsc-permits.php">MPSC</a></li>
				                         <div class="dropdown-divider"></div>
				                    </ul>
				             </li>
