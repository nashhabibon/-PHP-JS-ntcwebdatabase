				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a href="add-user.php" class="btn btn-primary" id="add-new">
							<li class="fas fa fa-user-plus"></li>
									Add New
								</a>
							</div>
						</div>
  ...
  if ($result && mysqli_num_rows($result) > 0) 
  {
    while ($row = $result -> fetch_assoc()) 
    {
      ...
      echo  "<tr>
       ...
       <td id='colortype'>" . $row["AccType"]  .  "</td>
       <td>" .
        ...
        "<div class='dropdown'>
                      ...
                      <div class='dropdown-menu dropdown-menu-right dropdown-menu-icon-list'>
                        <a class='dropdown-item' href='update-user.php?userId=" . $row['userId'] . "'  name='editbtn' id='editbtn'><i class='dw dw-edit2'></i> Edit</a>
                       <a class='dropdown-item' href='action/delete-user.php?userId=" . $row['userId'] . "' name='deletebtn' id='deletebtn'>
