		...
		<div class="pd-ltr-20 xs-pd-20-10">
				...
				<div class="card-box mb-20">
					<div class="page-header">
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="title">
									<h4><i class="fas fa fa-pencil mtext"></i> Update Users</h4>
								</div>
							</div>
						</div>
				</div>
		  <?php
		  	...
		  	include("../config/connection.php");
                ...
                $query = "SELECT * FROM tblaccount WHERE userId='$id' ";
							...
							<div class="input-group custom">
								...
								<div class="col-md-12 col-sm-12">
									<div class="form-group">
										...
										<input class="form-control form-control-lg" type="text" name="fullname" required="required" autocomplete="off" id="fullname" value="<?php echo $row['FullName'] ?>" >
									</div>
								</div> 
								...
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										<label>Contact</label>
										<input class="form-control form-control-lg" type="text" name="contact" required="required" autocomplete="off" id="contact" value="<?php echo $row['Contact'] ?>">
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										...
										<select class="selectpicker form-control form-control-lg" data-style="btn-outline-secondary btn-lg" name="acctype" required="required" autocomplete="off" id="acctype" >
										<option value="Admin"<?=$row['AccType'] == 'Admin' ? ' selected="selected"' : '';?> >Admin</option>
										<option value="Encoder"<?=$row['AccType'] == 'Encoder' ? ' selected="selected"' : '';?>>Encoder</option>	
										<option value="Engineer"<?=$row['AccType'] == 'Engineer' ? ' selected="selected"' : '';?>>Engineer</option>		
										</select>
									</div>
								</div>
								...
								<div class="col-md-12 col-sm-12">
									<div class="form-group">
										<label>Email</label>
										<input class="form-control form-control-lg" type="text" name="email" required="required" autocomplete="off" id="email" value="<?php echo $row['Email'] ?>">
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										...
										<input class="form-control form-control-lg" type="text" name="username" required="required" autocomplete="off" id="username" value="<?php echo $row['Username'] ?>">
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
										...
										<input class="form-control form-control-lg" type="password" name="password" required="required" autocomplete="off" id="password" value="<?php echo $row['Password'] ?>">
									</div>
								</div>
							<div class="col-md-12 col-sm-12">
									<div class="form-group">
										<input type="button" class="btn btn-primary" value="Submit" id="updatebtn">
